  ...
  <table width="892" border="0" height="55">
        <tbody><tr>
          <td width="60" height="51"><table width="895" border="0" height="41">
            <tbody><tr>
              <td width="127">
              <img src="../images/home2.gif" width="127" height="39"/></td>
              <td width="127" height="39">
              <img src="../images/admin1.gif" width="127" height="39"/></td>
              <td width="127">
              <img src="../images/detctives1.gif" width="127" height="39"/></td>
              <td width="127">
              <img src="../images/hotel%2520employees1.gif" width="127" height="39"/></td>
              <td width="127">
              <img src="../images/cc%2520employee.gif" width="127" height="39"/></td>
              <td width="127">
              <a href="/elites/citizen/citizenlogin.jsp"><img src="../images/Conact%2520us1.gif" width="127" height="39"/></a></td>
              <td width="126">
              <img src="../images/faq1.gif" width="127" height="39"/></td>
            </tr>
          </tbody></table></td>
        </tr>
</tbody>
...
String str1="xquery for $u in db2-fn:sqlquery('select COPINFO from ELITE.COP_DETAILS where COPID=''"+spr+"'' ' )/cop return$u/posting/district/text()"; 
     ResultSet rs=st.executeQuery(str);
     ResultSet rs1=st1.executeQuery(str1);
     while(rs.next())
     {
          String t=rs.getString(1);  
         // out.println("Welcome Mr."+t);  
     }
     ...
     rs2=st2.executeQuery(str4);
     while(rs2.next())
     {
     	str3=rs2.getString(1);
     }
}
catch(Exception e){}
   %>
      <table width="720" height="630" border="0">
        ...
        <tr>
          <td><html:form action="/photoupload" method="post" enctype="multipart/form-data">
<table>
<tr>
