...
<table width="927" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr> 
    ...
    <td valign="top">
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="1" height="588">
            ...
            <tr>
              ...
              <tr>
                <td width="17" height="52"><img src="images/arrow.gif" width="9" height="12"/></td>
                <td width="170"><a linkindex="8" href="/elites/fir/viewcomplaint.jsp" class="leftlink">Register a FIR</a></td>
              </tr>
              ...
              <tr>
                ...
                <td><a linkindex="9" href="#" class="leftlink">Access Case Details</a></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><img src="images/arrow.gif" width="9" height="12"/></td>
                <td><a linkindex="10" href="/elites/generaldiary/addgd.jsp" class="leftlink">Maintain General Diary</a></td>
              </tr>
              <tr>
                <td colspan="2"><img src="images/hrdotblue.gif" width="100%" height="1"/></td>
              </tr>
              <tr>
                <td><img src="images/arrow.gif" width="9" height="12"/></td>
                <td><a linkindex="11" href="#" class="leftlink">Maintain Criminal Record</a></td>
              </tr>
              <tr>
                <td colspan="2"><img src="images/hrdotblue.gif" width="100%" height="1"/></td>
              </tr>
   ...
   <%
    String str33="";
     String t1="";
     String t2="";String t="";  String t3=""; String t13="";
    try{
...
String str3="xquery for $c in db2-fn:sqlquery('select COPINFO from ELITE.COP_DETAILS where COPID=''"+spr+"'' ' )/cop return$c/posting/deptt/text()"; 
 ...
 while(rs3.next())
     {
       ...
       if(rs12.next())
     {
         t13=rs12.getString(1);     
         
     }
     
      String str5="select ps_no from ELITE.PSDET where pname='"+t2+"' and dname='"+t1+"'";
     ResultSet rs6=dm.executeQuery(str5);
     if(rs6.next())
     {
     session.setAttribute("psno",rs6.getString(1));
     }
    
     String str44="select link from ELITE.COP_DETAILS where copid='"+spr+"'";
     rs5=st4.executeQuery(str44);
     while(rs5.next())
     {
     	str33=rs5.getString(1);
     }
     con.close();
     dm.close();
     }
        ...
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
                ...
                <table border="0" cellspacing="0">
											<tbody>
												...
												<tr>
													...
													<td width="233" class="para1" height="36">Head Constable</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td width="233" class="para1" height="45"><%=t13 %></td>
												</tr>
												<tr>
												...
												<tr>
													<td width="220" class="para3" height="45">Department :</td>
              ...
              <td width="235"><img src="/elites/<%=str33 %>" height="200" width="235"/></td>
            </tr>
          </table></td>
        </tr>
        <tr>
