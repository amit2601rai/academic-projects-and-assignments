...
<table width="927" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr> 
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="1" height="588">
            ...
            <tr>
              ...
              <tr>
                ...
                <td><a linkindex="9" href="#" class="leftlink">View Case Diary</a></td>
              </tr>
              <tr>
    ...
    String spr="";  String t="";  String t1="";  String t2="";
     String str7="";
     ResultSet rs4;
     try{
     //ResultSet rs2;
...
String str2="xquery for $a in db2-fn:sqlquery('select COPINFO from ELITE.COP_DETAILS where COPID=''"+spr+"'' ' )/cop return$a/posting/circle/text()"; 
               ...
               <table border="0" cellspacing="0">
											<tbody>
												...
												<tr>
													...
													<td width="233" class="para1" height="36">Circle Officer</td>
												</tr>
												<tr>
