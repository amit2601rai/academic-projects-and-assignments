      ...
      <table width="720" height="630" border="0">
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194"><center><font face="Georgia, Times New Roman, Times, serif" color="#000FA" size="+2"><span class="head">Allot a police Officer to a Case</span></font></center><br><br><table border="0" cellspacing="0"><%
try
{	
	...
	int i=1;
	String z="";
	String str="SELECT * FROM ELITE.COMPLAINT AS COMPLAINT, ELITE.FIR AS FIR WHERE COMPLAINT.C_NO = FIR.C_NO AND COMPLAINT.PS_NO = "+psno+" AND FIR.COPAL = 'N/A'";
	ResultSet rs=dm.executeQuery(str);
	while(rs.next())
	{
	if(rs.getString(15).equals("cog"))
	{
	z="Cognizible";
	}
	else
	...
	%><tr height="50"><td class="para3"><%=i %> .</td><td><a href="/elites/copin.do?firno=<%=rs.getString(11) %>" ><span class="para1"> Deptt <%=rs.getString(14) %> <%=z %> Crime....</span></a></td></tr><%i++;
