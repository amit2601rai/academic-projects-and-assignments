...
<table width="927" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr> 
	...
	String cid=(String)request.getAttribute("comp_name");
	String ip=(String)request.getAttribute("ip");
	out.print("<span class='notify'>Your Complaint number is "+cid+",Keep It Safe.Your I.P. "+ip+" has been logged....</span>");
 %></td>
