  ...
  <table width="892" border="0" height="55">
        <tbody><tr>
          <td width="60" height="51"><table width="895" border="0" height="41">
            <tbody><tr>
              <td width="127">
              <img src="/elites/images/home2.gif" width="127" height="39"/></td>
              <td width="127" height="39">
              <img src="/elites/images/admin1.gif" width="127" height="39"/></td>
              <td width="127">
              <img src="/elites/images/detctives1.gif" width="127" height="39"/></td>
              <td width="127">
              <img src="/elites/images/hotel%2520employees1.gif" width="127" height="39"/></td>
              <td width="127">
              <img src="/elites/images/cc%2520employee.gif" width="127" height="39"/></td>
              <td width="127">
              <a href="/elites/citizen/citizenlogin.jsp"><img src="/elites/images/Conact%2520us1.gif" width="127" height="39"/></a></td>
              <td width="126">
              <img src="/elites/images/faq1.gif" width="127" height="39"/></td>
            </tr>
          </tbody></table></td>
        </tr>
</tbody>
      ...
      <table width="720" height="630" border="0">
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194"><center><span class="head">Complaints of today</span><center><br><br><br>
<%@ page import="java.sql.*" %>
<%@ page import="elites.model.*" %> 
<% 		ResultSet rs;
		String psno=(String)session.getAttribute("psno");
			try{
					int i=1;
					DbModel db= new DbModel();
					String query="select c_no from ELITE.COMPLAINT where attended='false' and ps_no="+psno;
					rs=db.executeQuery(query);		
					
					while(rs.next())
					{
					%><a href="/elites/complaintdetail.do?cno=<%=rs.getString(1) %>" ><span class="para1">Complaint<%=i %></span></a><br>
					<%i++;}
					}
				catch(Exception e)
				{out.print(e);}
