...
<table width="927" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr> 
	...
	String psno=(String)request.getAttribute("psno");
	String firno=(String)request.getAttribute("firno");
	 %>
	 
	 <center><span class="head">Details of this case are as follows</span></center><br><br>
	 <span class="para1"><%=detail %></span>
	 <br><br><span class="para1">Select a cop :</span>
	...
	String str2="select * from ELITE.PSDET where ps_no="+psno;
	rs=db.executeQuery(str2);
	if(rs.next())
	{
	}
	String str1="xquery for $y in db2-fn:xmlcolumn(\"ELITE.COP_DETAILS.COPINFO\")/cop where $y/posting/circle=\""+rs.getString(3)+"\" and $y/posting/psname=\""+rs.getString(2)+"\" and $y/rank=\"INSPECTOR\" return $y/name/text()";
	String str3="xquery for $y in db2-fn:xmlcolumn(\"ELITE.COP_DETAILS.COPINFO\")/cop where $y/posting/circle=\""+rs.getString(3)+"\" and $y/posting/psname=\""+rs.getString(2)+"\" and $y/rank=\"SUB-INSECTOR\" return $y/name/text()";
		String str4="xquery for $y in db2-fn:xmlcolumn(\"ELITE.COP_DETAILS.COPINFO\")/cop where $y/posting/circle=\""+rs.getString(3)+"\" and $y/posting/psname=\""+rs.getString(2)+"\" and $y/rank=\"INSPECTOR\" return $y/name/text()";
	String str5="xquery for $y in db2-fn:xmlcolumn(\"ELITE.COP_DETAILS.COPINFO\")/cop where $y/posting/circle=\""+rs.getString(3)+"\" and $y/posting/psname=\""+rs.getString(2)+"\" and $y/rank=\"SUB-INSECTOR\" return $y/name/text()";
	rs1=xm.executeQuery(str1);
	rs2=xm.executeQuery(str3);%>
	<form action=/elites/fir/allotbysho.jsp><select name="cop"> <%
	while(rs1.next())
	{
	%>
	...
	<input type="hidden" name="firno" value="<%=firno %>"/>
