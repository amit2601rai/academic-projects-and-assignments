  ...
  <tbody><tr> 
    ...
    <td valign="top" width="729" bgcolor="#CFC996">
      <table width="720" height="630" border="0">
		...
		String copname=request.getParameter("cop");
		String str="update ELITE.FIR set copal='"+copname+"' where fir_no="+firno;
		db.executeDML(str);
		 %>
		 <span class="notify"><%=copname %> has been allotted the case no.<%=firno %></span></td>
