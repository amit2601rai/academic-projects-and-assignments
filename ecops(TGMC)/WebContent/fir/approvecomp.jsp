...
function check(id)
{var b=id+"12";
i=document.getElementById(b).value;
j=i+1;
document.getElementById(i).innerHTML="<input type='text' size='6' name='"+id+"'/><span id='"+j+"'></span>";
  ...
  <tbody><tr> 
    ...
    <td valign="top" width="729" bgcolor="#CFC996">
      <table width="720" height="630" border="0">
		...
		<%String cno=(String)request.getAttribute("compno");
		ResultSet rs;
		DbModel db=new DbModel();
%><br><br>
<html:form action="firprocess">
<table width="690" border="0">
<tr height="50"><td width="330" class="para1">
Move to :</td>
<td width="350"><select name="deptt">
<option value="Law and Order">Law and Order</option>
<option value="woman protection">Woman Protection</option>
<option value="Traffic control">Traffic Control</option>
<option value="Cyber crime">Cyber Crime</option></select></td></tr>
...
try{
	String query3="select * from ELITE.SUSPECTED where c_no="+cno;
    	...
    	while(rs.next())
    	{
    	String a=rs.getString(2)+"12";%>
   <tr height="50"> <td class="para1"><%=rs.getString(2)%><input type="hidden" id="<%=a%>" value="<%=rs.getString(2)%>"/></td> <td><input type="text" name="<%=rs.getString(2)%>"/></td></tr>
...
Select type of crime :</td></tr>
<tr height="50"><td  class="para1">
Cognizible :<input type="radio" name="cr" value="cog"/></td>
<td class="para1">
Non-Cognizible :<input type="radio" name="cr" value="non"/></td></tr>
<tr height="30"><td class="para1">
Want to reject this complaint????<a href="/elites/rejectcomp.do?cno=<%=cno %>">reject</a><td>
<input type="submit" value="Approve"><input type="reset"/></td></tr></table></html:form></td>
