...
<%@ page import="elites.model.*" %>
	...
	<head>
    <title>Maintain General Diary</title>
	<style type="text/css">
	.head
	{
		font-weight:bolder;
      ...
      <table width="720" height="630" border="0">
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194"><html:form action="addgdaction">
              <table width="690" border="0">
									<tr height="50">
										<td> Enter serial no. :</td>
										<td><input type="text" name="srno" size="23"></td></tr>
									<tr height="50">
 										<td>Enter General Diary deatils :</td>
 										<td><textarea rows="4" cols="18" name="gddetails"></textarea></td></tr>
 										</table><br><br>
 									<center><input type="submit" name="submit" value="Add">
 											<input type="reset" name="submit"></center></html:form></td>
