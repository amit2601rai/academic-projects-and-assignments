      ...
      <table width="729" height="630" border="0" bgcolor=" #CFC996">
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194"><html:form action="/adminlogin">
										<table border="0">
											<tbody>
												<tr height="50"  class="head">
													<td width="355" colspan="2">Enter Login Details</td>
													
												</tr>
												<tr height="30">
													<td width="355" class="para1">Enter Admin Id :</td>
													<td width="338"><input type="text" name="id"/></td>
												</tr>
												<tr height="30">
													<td width="355" class="para1">Enter Password :</td>
													<td width="338"><input type="password" name="pwd"/></td>
												</tr>
												<tr height="50">
													<td width="355"></td>
													<td width="338"><input type="submit" value="Sign in"/>    <input type="reset" /></td>
												</tr>
											</tbody>
										</table>
