    ...
    <td valign="top">
          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="1" height="588">
            ...
            <tr>
              ...
              <tr>
                <td><img src="../images/arrow.gif" width="9" height="12"/></td>
                <td><a linkindex="11" href="#" class="leftlink">Maintain Case Diary</a></td>
              </tr>
              <tr>
                <td colspan="2"><img src="../images/hrdotblue.gif" width="100%" height="1"/></td>
              </tr>
      ...
      <table width="729" height="630" border="0" bgcolor=" #CFC996">
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194" align="center" valign="middle">  <html:form method="post" action="/cdaction">
                <div align="center"><span class="head">ENTER THE CASE DIARY DETAILS</span> <br>
                  <br>
                </div>
                <table width="690" border="0">
									<tr height="50">
										<td class="para1">Enter FIR no. :</td>
										<td><input type="text" name="firno"/></td></tr>
									<tr height="50">
										<td class="para1">Enter PAGE no. :</td>
										<td><input type="text" name="pageno"/></td></tr>
									<tr height="50">
										<td class="para1">Enter investigation details :</td>
										<td><input type="text" name="invdetails"/></td></tr></table><br><br>
										<center><input type="submit" name="submit" value="submit"/>
										<input type="reset"/><br></center>
									</html:form></td>
