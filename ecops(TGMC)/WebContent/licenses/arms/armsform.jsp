...
<tr height="50"><td class="para1">Owner :</td><td><input type="text" name="owner"></td></tr>
<tr height="50"><td class="para1">Weapon No. :</td><td><input type="text" name="wno"></td></tr>
<tr height="50"><td class="para1">Weapon Name :</td><td><input type="text" name="wname"></td></tr>
<tr height="50"><td class="para1">Weapon Model :</td><td><input type="text" name="wmodel"><input type="hidden" name="hid" value="1"></td></tr>
<tr height="50"><td></td>
<td><input type="submit" value="submit"><input type="reset"></td></tr></table>
</html:form>						
