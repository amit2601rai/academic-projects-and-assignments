...
<tr height="50"><td class="para1">OWNER :</td>
<td><input type="text" name="owner"></td></tr>
<tr height="50"><td class="para1">Place of Occurence :</td>
<td><input type="text" name="poo">  </td></tr>
<tr height="50"><td class="para1">Start Time :</td>
<td><input type="text" name="stime"></td></tr>
<tr height="50"><td class="para1">End Time :</td>
<td><input type="text" name="etime"></td></tr>
<tr height="50"><td class="para1">Reason of using Loudspeaker :</td>
<td><input type="text" name="reason">
<input type="hidden" name="hid" value="3"> </td></tr>
<tr height="50"><td>&nbsp;</td>
