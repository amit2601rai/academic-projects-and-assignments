          ...
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194">
					...
					<html:form action="reqlicenseaction"><table width="690" border="0">
					<tr height="25" ><td colspan="2" class="head">
FOR MASS MEETINGS</td></tr>
<tr height="50"><td class="para1">Enter your citizen id :</td>
<td><input type="text" name="ctzid"> </td></tr>
<tr height="50"><td class="para1">Select a zone name :</td><td> <select name="zone">
...
<tr height="50"><td class="para1">Select a Range :</td>
<td><span id="a"><select name="1">
<option value="n">select</option></select></span></td></tr>
<tr height="50"><td class="para1">Select a District :</td>
<td><span id="b"><select name="2">
<option value="n">select</option></select></span></td></tr>
<tr height="50"><td class="para1">Select a Circle :</td>
<td><span id="c"><select name="3">
<option value="n">select</option></select>
</span>
<span id="h1"></span>
<span id="h2"></span></td></tr>
<tr height="50"><td class="para1">Select a Police Station :</td>
<td><span id="ps"><br>
<select name="4">
<option value="n">select</option>
</select>
</span> </td></tr>
<tr height="50"><td class="para1">Select an Area :</td>
<td><span id="ar">
<select name="5">
<option value="n">select</option>
</select>
</span></td></tr>	
<tr height="50"><td class="para1">Reason for meeting :</td><td><input type="text" name="reason"></td></tr>
<tr height="50"><td class="para1">Place of Occurence :</td><td><input type="text" name="poo"></td></tr>
<tr height="50"><td class="para1">Type of mass meeting :</td><td><input type="text" name="mmtype"></td></tr>
<tr height="50"><td class="para1">Start Time :</td><td><input type="text" name="stime"></td></tr>
<tr height="50"><td class="para1">End Time :</td><td><input type="text" name="etime"></td></tr>
<tr height="50"><td class="para1">Number of Participants</td><td><input type="text" name="tnop">

<td><input type="hidden" name="hid" value="4"></td></tr>
<tr height="50"><td>&nbsp;</td>
