...
<%@ page import="elites.model.*" %>
	...
	<head>
    <title>Enter ChargeSheet No</title>
          ...
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194">
				...
				<form action="viewchargesheet.jsp" method="post">
  
										<table border="000" border-color="#131A9F">
											<tbody>
												<tr bgcolor="#131A9F" class="notify1">
													<td width="345" colspan="2" >Enter the Chargesheet Number</td>
													
												</tr>
												<tr height="80">
													<td width="345" class="para1">Enter charge sheet no</td>
													<td width="347"><input type="text" name="csno"/></td>
												</tr>
												<tr height="80">
												<td width="345">&nbsp;</td>
												<td width="347"><input type="submit" value="submit"><input type="reset"></td>
												</tr>
											</tbody>
										</table>
</form>						
