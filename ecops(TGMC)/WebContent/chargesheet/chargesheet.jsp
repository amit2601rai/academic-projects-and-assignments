  ...
  <tbody><tr> 
    ...
    <td valign="top" width="729" bgcolor=" #CFC996">
          ...
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194">
								      ...
								      <%   out.println("inaction");String query="",query1="",query2="";
        String arr[]=request.getParameterValues("cid");
        String arr1[]=request.getParameterValues("name");     
        String arr2[]=request.getParameterValues("address");
        String arr3[]=request.getParameterValues("acts");       
        String arr4[]=request.getParameterValues("cid1");
        String arr5[]=request.getParameterValues("name1");     
        String arr6[]=request.getParameterValues("address1");
        String firno=request.getParameter("firno");
        String inv=request.getParameter("investigation");
      ...
      try{ 
        ...
        query="insert into ELITE.CHARGESHEET1 (ps_no,copid,fir_no,timestamp,summary) values("+psno+",'"+cop_id+"',"+firno+",'"+timestamp+"','"+inv+"')";
           lm.executeDML(query);
         for(int i=0;i<arr.length;i++)
          { 
        	query1="insert into ELITE.CHARGESHEET2(fir_no,crid,crname,cradd,acts) values("+firno+","+arr[i]+",'"+arr1[i]+"','"+arr2[i]+"','"+arr3[i]+"')"; 
            out.println(query1);
            lm.executeDML(query1);
         }
        
        for(int i=0;i<arr4.length;i++)
          { 
           query2="insert into ELITE.CHARGESHEET3(fir_no,wid,wname,wadd) values("+firno+","+arr4[i]+",'"+arr5[i]+"','"+arr6[i]+"')"; 
           out.println(query2);
          lm.executeDML(query2);
         }
       ...
       %><span class="notify">Chargesheet has been filed</span>		
