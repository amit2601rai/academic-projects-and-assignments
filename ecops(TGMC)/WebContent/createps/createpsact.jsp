...
//Integer l=(Integer)session.getAttribute("length");

int i;
String ps=request.getParameter("psname"); 
String cname=request.getParameter("circle");
String dname=request.getParameter("district");
...
{
String str="insert into ELITE.DCPA values('"+dname+"','"+cname+"','"+ps+"','"+options[i]+"')";
db.executeDML(str);
...
out.print("caught");
 ...
 %> <div class="notify">A New Police Station has been created</div> </td>
