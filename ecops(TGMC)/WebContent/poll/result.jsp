...
int a=0,b=0,c=0,d=0,e=0,f,g,h,i;
...
String str="select * from ELITE.POLL_QUESTION where qid="+id;
try{
	...
	op3=rs.getString(6);
	op4=rs.getString(7);
	String str1="select count(choice) from ELITE.POLL_ANSWER where choice='1' and qid="+id;	
	String str2="select count(choice) from ELITE.POLL_ANSWER where choice='2' and qid="+id;	
	String str3="select count(choice) from ELITE.POLL_ANSWER where choice='3' and qid="+id;	
	String str4="select count(choice) from ELITE.POLL_ANSWER where choice='4' and qid="+id;	
	rs1=db.executeQuery(str1);
	rs2=db.executeQuery(str2);
	rs3=db.executeQuery(str3);
	rs4=db.executeQuery(str4);
	if(rs1.next())
	{
	a=rs1.getInt(1);
	}
...
eb.printStackTrace();}
 ...
 <table border="0">
											<tbody>
												<tr>
													<td colspan="2" class="head">Results of Poll</td>
													
												</tr>
												<tr>
													<td colspan="2" class="para3">Question :<%=question %></td>
													
												</tr>
												<tr>
													<td width="212" class="para3"> 1. <%=op1 %></td>
													<td width="482" class="para1"> <%=a %>%</td>
												</tr>
												<tr>
													<td width="212" class="para3"> 2. <%=op2 %></td>
													<td width="482" class="para1"> <%=b %>%</td>
												</tr>
												<tr>
													<td width="212" class="para3"> 3. <%=op3 %></td>
													<td width="482" class="para1"> <%=c %>%</td>
												</tr>
												<tr>
													<td width="212" class="para3"> 4. <%=op4 %></td>
													<td width="482" class="para1"> <%=d %>%        (Total no. of Votes <%=e %>)</td>
												</tr>
											</tbody>
										</table>
