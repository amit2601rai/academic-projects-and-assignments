  ...
  <tbody><tr> 
    ...
    <td valign="top" width="729" bgcolor="#CFC996">
      <table width="729" height="630" border="0" bgcolor=" #CFC996">
            ...
            <tr>
              <td width="457" height="194">
										<table border="0">
											<tbody>
												<tr height="50">
													<td colspan="2" class="head">Express yourself through Polls!!!</td>
		...
		String str="select * from ELITE.POLL_QUESTION";
		ResultSet rs=db.executeQuery(str);
		while(rs.next())
		{
			%><tr height="30"><td width="38" class="para3"><%=i %> .</td><td width="656" class="para1"><a href="/elites/poll/viewpollaction.jsp?id=<%=rs.getString(1) %>"> <%=rs.getString(2) %></a></td>
												</tr>
			<%
		i++;
		}
