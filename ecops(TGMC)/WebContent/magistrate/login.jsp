...
<%@ page import="elites.model.*" %>
	...
	<head>
    <title>Login of Magistrate</title>
      ...
      <table width="720" height="630" border="0">
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194"><center><h3><span class="head">Enter Login Details</span></h3></center>
              <html:form action="mgloginaction">
<center><table><tr><td class="para1">User Id(Magistrate) : </td><td><input type="text" name="mgid"></td></tr>
<tr><td class="para1">Password :</td><td><input type="password" name="pwd"></td></tr></table><br>
