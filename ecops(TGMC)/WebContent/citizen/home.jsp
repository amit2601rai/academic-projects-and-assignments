          ...
          <table width="100%" border="0" cellpadding="2" cellspacing="1" height="588">
            ...
            <tr>
              ...
              <tr>
                ...
                <td><a linkindex="10" href="/elites/fir/complaintlodging.jsp" class="leftlink">Lodge a Complaint</a></td>
              </tr>
               <tr>
              ...
              <tr>
                <td width="17" height="52"><img src="/elites/images/arrow.gif" width="9" height="12"/></td>
                <td width="170"><a linkindex="8" href="/elites/forum/questionforum.jsp" class="leftlink">Add a Question in Forum</a></td>
              </tr>
                 <tr>
                <td colspan="2" height="5"><img src="/elites/images/hrdotblue.gif" width="100%" height="1"/></td>
              </tr>
              <tr>
                <td width="17" height="52"><img src="/elites/images/arrow.gif" width="9" height="12"/></td>
                <td width="170"><a linkindex="8" href="/elites/licenses/arms/armsform.jsp" class="leftlink">Apply for Arms License</a></td>
              </tr>
        <tr>
                <td colspan="2" height="5"><img src="/elites/images/hrdotblue.gif" width="100%" height="1"/></td>
              </tr>
              <tr>
                <td width="17" height="52"><img src="/elites/images/arrow.gif" width="9" height="12"/></td>
                <td width="170"><a linkindex="8" href="/elites/licenses/massmeeting/massmeetingform.jsp" class="leftlink">Apply for Mass meeting License</a></td>
              </tr>
              <tr>
                <td colspan="2" height="5"><img src="/elites/images/hrdotblue.gif" width="100%" height="1"/></td>
              </tr>
              <tr>
                <td width="17" height="52"><img src="/elites/images/arrow.gif" width="9" height="12"/></td>
                <td width="170"><a linkindex="8" href="/elites/licenses/loudspeakers/loudspeakersform.jsp" class="leftlink">Apply for Loudspeakers License</a></td>
              </tr>
              ...
              <tr>
                <td><img src="/elites/images/arrow.gif" width="9" height="12"/></td>
                <td><a linkindex="9" href="/elites/forum/viewforum.jsp" class="leftlink">View Forum</a></td>
              </tr>
              ...
              <tr>
                <td><img src="/elites/images/arrow.gif" width="9" height="12"/></td>
                <td><a linkindex="10" href="/elites/poll/questionpoll.jsp" class="leftlink">Add a poll</a></td>
              </tr>
              <tr>
                <td colspan="2"><img src="/elites/images/hrdotblue.gif" width="100%" height="1"/></td>
              </tr>
              <tr>
                <td><img src="/elites/images/arrow.gif" width="9" height="12"/></td>
                <td><a linkindex="11" href="/elites/poll/viewpoll.jsp" class="leftlink">View Polls</a></td>
              </tr>
              <tr>
                <td colspan="2"><img src="/elites/images/hrdotblue.gif" width="100%" height="1"/></td>
              </tr>
      ...
      <table width="720" height="630" border="0">
        <tr>
          <td height="214"><table width="708" height="200" border="0">
    		...
    		String spr="";
    		  String str3="";
    		   spr=(String)session.getAttribute("cid");
    		   try{
    		   XmlModel xm=new XmlModel();
    		   String str="xquery for $y in db2-fn:sqlquery('select INFO from ELITE.CITIZEN where CID="+spr+" ')/citizen return$y/photo/text()";
				System.out.println(str);
				ResultSet rs1=xm.executeQuery(str);
				if(rs1.next())
	      {
	    	  str3=rs1.getString(1);
	      }
            ...
            <td width="235"><img src="/elites/<%=str3 %>" height="200" width="235"/></td>
