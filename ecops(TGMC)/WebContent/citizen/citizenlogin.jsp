...
<span class="head">Enter Login details</span><br><br><html:form action="/claction">
										<table border="0">
											<tbody>
												<tr>
													<td width="341" class="para1">Enter Citizen Id :</td>
													<td width="353"><input type="text" name="cid"></td>
												</tr>
												<tr>
													<td width="341" class="para1">Enter Password :</td>
													<td width="353"><input type="password" name="pwd"></td>
												</tr>
											</tbody>
										</table>
