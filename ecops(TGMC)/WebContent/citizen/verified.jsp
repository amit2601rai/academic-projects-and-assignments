      ...
      <table width="729" height="630" border="0" bgcolor=" #CFC996">
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194"><%String cid=(String)request.getAttribute("cid");%>
              <h3>Hi,Your Account has been verified,now you can login to proceed,your citizen id is <%=cid %></h3>
              </td>
