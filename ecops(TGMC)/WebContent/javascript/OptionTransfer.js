...
function moveAllOptions(from,to){selectAllOptions(from);if(arguments.length==2){moveOptions(from,to);}else if(arguments.length==3){moveOptions(from,to,arguments[2]);}else if(arguments.length==4){moveOptions(from,to,arguments[2],arguments[3]);}}
