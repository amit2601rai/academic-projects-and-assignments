...
<%@ page import="elites.model.*" %>
	...
	<head>
    <title>Allot By Station House Officer</title>
	<style type="text/css">
	.head
	{
		font-weight:bolder;
        ...
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              ...
              <center><h1>Featured Topics</h1></center>
<table>
<%
		int i=1;
		DbModel db=new DbModel();
		String str="select * from ELITE.FORUM_QUESTION";
		ResultSet rs=db.executeQuery(str);
		while(rs.next())
		{
			%><tr height="40"><td class="para3"><%=i %> .</td><td class="para1"><a href="/elites/forum/viewaction.jsp?id=<%=rs.getString(1) %>"> <%=rs.getString(2) %></a></td></tr><%
		i++;
		}
		db.close();
