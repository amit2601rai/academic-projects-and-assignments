  ...
  <table width="892" border="0" height="55">
        <tbody><tr>
          <td width="60" height="51"><table width="895" border="0" height="41">
            <tbody><tr>
              <td width="127">
             <a href="index1.html"><img src="/elites/images/home2.gif" width="127" height="39"/></a></td>
              <td width="127" height="39">
             <a href="admin.jsp"><img src="/elites/images/admin1.gif" width="127" height="39"/></a></td>
              <td width="127">
              <a href="#"><img src="/elites/images/detctives1.gif" width="127" height="39"/></a></td>
              <td width="127">
             <a href="coplogin/login.jsp"> <img src="/elites/images/hotel%2520employees1.gif" width="127" height="39"/></a></td>
              <td width="127">
             <a href="licenses/hotelncentres/hotelsncentresform.jsp"> <img src="/elites/images/cc%2520employee.gif" width="127" height="39"/></a></td>
              <td width="127">
              <a href="/elites/citizen/citizenlogin.jsp"><img src="/elites/images/Conact%2520us1.gif" width="127" height="39"/></a></td>
              <td width="126">
            <a href="magistrate/login.jsp"> <img src="/elites/images/faq1.gif" width="127" height="39"/></a></td>
            </tr>
          </tbody></table></td>
        </tr>
</tbody>
...
<table width="927" align="center" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr> 
	...
	//	String email=request.getParameter("Email");
		...
		String str7="insert into ELITE.FORUM_ANSWER(qid,ctzid,name,email,answer,timestamp) values ("+qid+","+ctzid+",'"+name+"','"+email+"','"+answer+"','"+tempdate+"')";
	    dm.executeDML(str7);
	    String str3="select reply from ELITE.FORUM_QUESTION where qid="+qid;
	    System.out.print("111");
	    rs=dm.executeQuery(str3);
	    ...
	    rep++;
	    String str2="update ELITE.FORUM_QUESTION set reply="+rep+" where qid="+qid;
	        dm.executeDML(str2);
	    }
	    catch(Exception e)
	    {out.print(e);
...
%>
<a href="viewaction.jsp?id=<%=qid %>"><span class="para1">back to forum</span></a>
              </td>
