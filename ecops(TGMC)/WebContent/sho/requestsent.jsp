...
<%@ page import="elites.model.*" %>
	...
	<head>
    <title>Request sent to Magistrate</title>
	<style type="text/css">
	.head
	{
		font-weight:bolder;
          ...
          <td width="60" height="51"><table width="895" border="0" height="41">
            <tbody><tr>
             ...
             <a href="/elites/admin.jsp"><img src="/elites/images/admin1.gif" width="127" height="39"/></a></td>
              ...
              <td width="127"><a href="/elites/coplogin/login.jsp"><img
						src="/elites/images/hotel%2520employees1.gif" width="127" height="39"></a></td>
              <td width="127">
      ...
      <table width="729" height="630" border="0" bgcolor="#CFC996">
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194"><h3>Your Request for Warrant has been sent to the Magistrate,
              you will get it through E-mail</h3></td>
