...
<%@ page import="elites.model.*" %>
	...
	<head>
    <title>Request for Warrant</title>
	<style type="text/css">
	.head
	{
		font-weight:bolder;
      ...
      <table width="720" height="630" border="0">
        <tr>
          <td height="214"><table width="708" height="200" border="0">
            <tr>
              <td width="457" height="194"><html:form action="reqarrestaction"><table width="690" border="0">
<tr height="50">
<td>firno :</td><td><input type="text" name="firno"></td></tr>
<tr height="50">
<td>against whom :</td><td><input type="text" name="whom"></td></tr>
<tr height="50">
<td>Reason/details :</td><td><input type="text" name="reason"></td></tr>
<tr height="50">
<td>Court number :</td><td><input type="text" name="courtno"></td></tr></table><br><br>
<center><input type="submit" name="submit" value="Apply">
<input type="reset" name="submit"></center>
</html:form></td>
