...
public class loadArealic extends Action
{
		  ...
		  try
		  	{
		  		...
		  		String query="select aname from ELITE.DCPA where dname='"+temp_district+"'and cname='"+temp_circle+"' and pname='"+temp_ps+"'";
		  	...
		  	//	rs1=db.executeQuery(query1);
		  		...
		  		responseText=responseText+"<select name='area'>";
		  		if(rs.next()==false)
		  		{
